...
def fold_run(device):
    ...
    inter = np.load(f'/data/hcfeng/envs/get_rna/upload_model/benchmark/interactions.npy')
    rna_vector = np.load(f'/data/hcfeng/envs/get_rna/upload_model/benchmark/rna_vector.npy')
    protein_vector = np.load('/data/hcfeng/envs/get_rna/upload_model/benchmark/protein_vector.npy')
    rna_similarity = np.load('/data/hcfeng/envs/get_rna/upload_model/benchmark/rna_similarity.npz')
    rna_index = rna_similarity['edge']
    rna_val = rna_similarity['weight']
    protein_similarity = np.load(f'/data/hcfeng/envs/get_rna/upload_model/benchmark/protein_similarity.npz')
